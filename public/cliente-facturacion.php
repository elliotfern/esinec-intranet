                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            for(var i=0; i<data.length; i++){
                                ...
                                html += '<td>' + data[i].importe.toLocaleString('es-ES', { style: 'currency', currency: 'EUR' }) + '</td>';
                                html += '<td>';
                                ...
                                html += '<td><button type="button" onclick="btnUpdateBook('+data[i].id+')" id="btnUpdateBook" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modalUpdateBook" data-id="'+data[i].id+ '" value="'+data[i].id+ '" data-title="'+data[i].id+ '" data-slug="'+data[i].id+ '" data-text="'+data[i].id+ '">¿Cobrado?</button>';
                                html += '</td>';
                                html += '</tr>';
                            }
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            for(var i=0; i<data.length; i++){
                                ...
                                html += '<td>' + data[i].importeTotal.toLocaleString('es-ES', { style: 'currency', currency: 'EUR' }) + '</td>';
